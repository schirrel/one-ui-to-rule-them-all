...
class AlbsButton extends s {
    ...
    render() {
      ...
      ?disabled="${this.disabled}"
        ...
        ${this.loading
            ? $ `<span class="albs-button--loading"></span>`
            : $ ``}
...
__decorate([
    e({ type: String })
], AlbsButton.prototype, "greeting", void 0);
__decorate([
    e({ type: String })
], AlbsButton.prototype, "planet", void 0);
__decorate([
    e({ type: String })
], AlbsButton.prototype, "type", void 0);
__decorate([
    e({ type: Boolean })
], AlbsButton.prototype, "disabled", void 0);
__decorate([
    e({ type: Boolean })
], AlbsButton.prototype, "loading", void 0);
