...
class AlbsInput extends s {
    constructor() {
        super(...arguments);
        this.type = 'text'; //https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#attributes
        this.inputmode = "text"; //https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/inputmode
        this.placeholder = "";
        this.disabled = false;
        this.required = false;
        this.__value = null;
    ...
    handleChange(event) {
        ...
        if (this.reactHandler) {
            ...
            this[this.reactHandler].onChange(this.__value);
        }
        else {
...
__decorate([
    e({ type: String })
], AlbsInput.prototype, "type", void 0);
__decorate([
    e({ type: String })
], AlbsInput.prototype, "inputmode", void 0);
__decorate([
    e({ type: String })
], AlbsInput.prototype, "placeholder", void 0);
__decorate([
    e({ reflect: true, })
], AlbsInput.prototype, "disabled", void 0);
__decorate([
    e({ reflect: true, })
], AlbsInput.prototype, "required", void 0);
__decorate([
    i("input")
], AlbsInput.prototype, "element", void 0);
__decorate([
    e({})
], AlbsInput.prototype, "value", null);
