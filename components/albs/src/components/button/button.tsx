...
export class Button {
  ...
  private onClick(event) {
    ...
    if (this.type === 'button') return this.clickEmitter.emit(event);
    else {
  ...
  render() {
    return (
      <button onClick={this.onClick.bind(this)} type={this.type} disabled={this.disabled} data-loading={this.loading}>
        {this.loading ? (
