import { r as registerInstance, c as createEvent, h, g as getElement } from './index-7cf8ac4a.js';
...
const Input = class {
  ...
  setValue(value) {
    ...
    this.inputEmitter.emit(new InputEvent('change', {
      data: this.value,
    }));
    this.inputEmitter.emit(new InputEvent('beforeinput', {
      data: this.value,
    }));
    this.inputEmitter.emit(new CustomEvent('change', {
      detail: {
        value: this.value,
      },
    }));
